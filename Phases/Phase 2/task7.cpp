...
int main()
{
    ...
    do
    {
        ...
        case 0:
            ...
            break;
        case 1:
            cout << "Area of Circle Is: " << circle.getArea(radius) << endl;
            break;
        case 2:
            cout << "Perimeter of Circle Is: " << perimeter_circle.getPerimeter(radius) << endl;
            break;
        case 3:
            cout << "Diameter of Circle Is: " << diameter_circle.getDiameter(radius) << endl;
            break;
        default:
